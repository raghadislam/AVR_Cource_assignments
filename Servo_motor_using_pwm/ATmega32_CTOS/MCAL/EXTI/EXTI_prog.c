...
/* pointers to function of each one of the external interrupt (INT0,INT1-INT2)*/
 ...
 *
 * @param Copy_pstrEXTIConfig : pointer to EXTI_t struct which contains the initial states of each interrupt pin
 *
...
/**
 * @brief A function to set the sense control of the required external interrupts
 *
 * @param Copy_u8INTPin: the required external interrupt pin
 *
 * @param Copy_u8Sense : the sense control of the external interrupt
 *
 * @return the Error state of the function
 */
...
/**
 * @brief A function to enable the required external interrupts
 *
 * @param Copy_u8INTPin: required external interrupt pin
 *
 * @return the Error state of the function
 */
...
/**
 * @brief A function to disable the required external interrupts
 *
 * @param Copy_u8INTPin: required external interrupt pin
 *
 * @return the Error state of the function
...
/**
 * @brief functions to set the callback function for (INT0,INT1,INT2)
 *
 * @param Copy_pvUserISR: the address of the callback function
 *
 * @return the Error state of the function
 */
