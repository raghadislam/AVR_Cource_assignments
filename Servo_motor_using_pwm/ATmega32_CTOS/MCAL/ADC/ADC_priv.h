...
/* macro for checking if the prescaler selected is valid */
...
/* macro for checking if the trigger source selected is valid */
...
/* macro for checking if the channel selected is valid */
#define IS_VALID_CHANNEL(CHANNEL) ((CHANNEL) >=0 && (CHANNEL)<= 31)


/* macros for bits masking */
...
/* private macros to help checking the interrupt flag */
#define ADC_LOW 				0

/* private macros to help determining the ADC state */
#define ADC_IDLE 				9
#define ADC_BUSY				8

/* private macros to help determining the ADC conversion type */
